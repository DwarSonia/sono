...
let handler = async (m, { conn, args, usedPrefix, command }) => {
    ...
    if (!args[0]) throw `*Este comando é para recuperar adesivos da linha*\n\nExemplos de uso:\n${usedPrefix + command} https://store.line.me/stickershop/product/8149770`
    if (!args[0].match(/(https:\/\/store.line.me\/stickershop\/product\/.*)/gi)) throw `*Este comando é para recuperar adesivos da linha*\n\nExemplos de uso:\n${usedPrefix + command} https://store.line.me/stickershop/product/8149770`
